...
- [**SwitchMonitors**](https://github.com/xantari/SwitchMonitors) — Monitor switching automation via DDC/CI commands
- [**USBPiSwitcher**](https://github.com/xantari/USBPiSwitcher) — Remote USB switching between Raspberry Pi and UGREEN hardware
